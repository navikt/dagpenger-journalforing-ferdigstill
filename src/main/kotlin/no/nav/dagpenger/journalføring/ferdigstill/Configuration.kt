...
private val devProperties = ConfigurationMap(
    mapOf(
        ...
        "ignore.journalpost" to "467199494, 453483019, 467026569, 467199494, 493328921, 493329280,493329282,493329283,493329285, 493329628, 493344317, 493345153, 493345172",
        "kafka.processing.guarantee" to StreamsConfig.AT_LEAST_ONCE
    )
)
