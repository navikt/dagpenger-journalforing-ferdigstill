...
private val devProperties = ConfigurationMap(
    mapOf(
        ...
        "ignore.journalpost" to "467199494, 453483019, 467026569, 467199494, 493328921, 493329280,493329282,493329283,493329285, 493329628, 493344317, 493345153, 493345172, 493345176",
        "kafka.processing.guarantee" to StreamsConfig.AT_LEAST_ONCE
    )
)
private val prodProperties = ConfigurationMap(
    mapOf(
        ...
        "unleash.url" to "https://unleash.nais.io/api/",
        "ignore.journalpost" to "493345295, 467048844, 477201031, 476557172, 475680871, 471479059, 471479060, 471478910, 467047358, 485283071, 490603325, 490587791,490587791,491096964,491096222,491098497,497902755,498196657",
        "kafka.processing.guarantee" to StreamsConfig.AT_LEAST_ONCE
    )
)
