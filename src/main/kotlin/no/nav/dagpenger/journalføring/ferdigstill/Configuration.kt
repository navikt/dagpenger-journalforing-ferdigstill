...
private val prodProperties = ConfigurationMap(
    mapOf(
        ...
        "ignore.journalpost" to "467048844, 477201031, 476557172, 475680871, 471479059, 471479060, 471478910, 467047358, 485283071, 490603325, 490587791,490587791,491096964,491096222,491098497",
        "kafka.processing.guarantee" to StreamsConfig.AT_LEAST_ONCE
    )
)
