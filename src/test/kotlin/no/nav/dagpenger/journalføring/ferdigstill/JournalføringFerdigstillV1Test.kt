...
internal class JournalføringFerdigstillV1Test {
    ...
    fun `Skal ta imot pakker med journalpostId`() {
        ...
        val ApplicationV1 = ApplicationV1(Configuration(), mockk(), FakeUnleash())

        ApplicationV1.filterPredicates().all {
...
class IgnorerJournalpostV1Test : FreeSpec({
