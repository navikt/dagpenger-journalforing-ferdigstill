...
val cxfVersion = "3.4.1" // Kan ikke oppdateres uten videre, må undersøkes: java.lang.NoSuchMethodError: ’org.codehaus.stax2.ri.EmptyIterator org.codehaus.stax2.ri.EmptyIterator.getInstance()
